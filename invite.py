...
async def on_ready():
	...
	await client.change_presence(game=discord.Game(name='A Bot Made By PleamPer Listing Your Invites')) 
	print('------\n')
...
client.run('ODA2NDA4NTkzOTIyNDU3NjYy.YBpAhw.Se0UuhDgE8yeQNsIHYXeSoogWQE') 
